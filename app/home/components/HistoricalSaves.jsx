...
const HistoricalSaves = ({ transactions, transactionsInvest, benefitTransactions, expenseTransactions }) => {
    const staticData = {
        labels: [],
        datasets: [
          {
      ...
      useEffect(() => {
        ...
        keys.forEach((key) => {
          ...
          idealList.push((totalBenefit * 0.45).toFixed(2))
        });
...
export default HistoricalSaves
