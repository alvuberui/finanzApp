...
const AnualNecessary = ({transactions, benefitTransactions, investmentBenefitTransactions}) => {
    ...
    const options = {
      ...
      useEffect(() => {
        ...
        const idealData55 = idealDataTotal.map(value => value * 0.4);
