...
const MonthDonut = ({ transactions }) => {
  const labels = ['Gastos innecesarios', 'Ahorro', 'Dinero invertido', 'Gastos necesarios'];
      ...
      datasets: [
        {
          ...
          data: [innecesaryPercentage, savingPercentage, investmentPercentage, necessaryPercentage],
        },
      ],
    };
