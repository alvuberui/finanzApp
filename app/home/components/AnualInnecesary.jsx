...
const AnualInnecesary = ({ transactions, benefitTransactions, investmentBenefitTransactions }) => {
  ...
  const options = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: 'Gastos innecesarios anuales',
      },
    },
  };
  ...
  useEffect(() => {
    ...
    const idealData15 = idealDataTotal.map(value => value * 0.15);
...
export default AnualInnecesary;
